    ...
    class GGJController
    {
        private static List<Game> _Games = new List<Game>()
        {
            ...
            (
                ...
                "C# (Unity)",
                "PC",
                new string[] {"Puzzles based on energy transfer","A variety of interaction mechanics","Cool spinny gun with diagetic UI"},
                "",
                "",
                "",
                "",
            ...
            (
                ...
                "C# (Unity)",
                "PC",
                new string[] {"Use your controllers to rip and tear","physics based destruction","Highly detailed mech robot"},
                "",
                "",
                "",
                "",
